# MCP Configuration Integration - Changelog
...
```
- Estructura de directorios para diferentes tipos de eventos
...
if audit_config.get("enabled"):
    ...
    # Rotación automática after 90 días
...
✓ Bloqueadas operaciones: 6 operaciones
...
- [x] .mcp.json mejorado con security estricta
